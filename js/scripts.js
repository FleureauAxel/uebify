$(document).ready(function(){
    ...
    fadeD = document.querySelectorAll(".faded_down"),
    fadeUD = document.querySelectorAll(".faded_ud"),

    fadeLpad = document.querySelectorAll(".faded_left_pad"),
    fadeRpad = document.querySelectorAll(".faded_right_pad"),
    ...
    entries.forEach(entry => {
        ...
        entry.target.classList.add("fadeInUpDx");
        leftOnScroll.unobserve(entry.target);
        }
    });
    },
    appearOptions);

    const leftOnScroll = new IntersectionObserver(function(
        entries,
        leftOnScroll
    ) {
    entries.forEach(entry => {
    ...
    const rightOnScroll = new IntersectionObserver(function(
        entries,
        rightOnScroll
    ) {
    entries.forEach(entry => {
        ...
        rightOnScroll.unobserve(entry.target);
        }
    });
    },
    appearOptions);
    
    const topOnScroll = new IntersectionObserver(function(
        entries,
        topOnScroll
    ) {
    entries.forEach(entry => {
        ...
        topOnScroll.unobserve(entry.target);
        }
    });
    },
    appearOptions);
    
    const downOnScroll = new IntersectionObserver(function(
        entries,
        downOnScroll
    ) {
    entries.forEach(entry => {
        ...
        downOnScroll.unobserve(entry.target);
        }
    });
    },
    appearOptions);
    ...
    fadeL.forEach(fader => {
        leftOnScroll.observe(fader);
      });

    fadeUD.forEach(fader => {
    udOnScroll.observe(fader);
    });

    fadeR.forEach(fader => {
        rightOnScroll.observe(fader);
    });

    fadeD.forEach(fader => {
        downOnScroll.observe(fader);
      });

    fadeT.forEach(fader => {
        topOnScroll.observe(fader);
    });

    //transitions with padding determined by "appearOptions1" attributes.

    const leftOnScrollPad = new IntersectionObserver(function(
        entries,
        leftOnScrollPad
    ) {
    entries.forEach(entry => {
        ...
        entry.target.classList.add("fadeInLeft");
        leftOnScrollPad.unobserve(entry.target);
        }
    });
    },
    appearOptions1);
    
    const rightOnScrollPad = new IntersectionObserver(function(
        entries,
        rightOnScrollPad
    ) {
    entries.forEach(entry => {
        ...
        entry.target.classList.add("fadeInRight");
        //rightOnScrollPad.unobserve(entry.target);
        }
    });
    },
    appearOptions1);
    
    const topOnScrollPad = new IntersectionObserver(function(
        entries,
        topOnScrollPad
    ) {
    entries.forEach(entry => {
        ...
        entry.target.classList.add("fadeInTop");
        //topOnScrollPad.unobserve(entry.target);
        }
    });
    },
    appearOptions1);
    
    const downOnScrollPad = new IntersectionObserver(function(
        entries,
        downOnScrollPad
    ) {
    entries.forEach(entry => {
        ...
        entry.target.classList.add("fadeInDown");
        //downOnScrollPad.unobserve(entry.target);
        }
    });
    },
    appearOptions1);
    
    fadeLpad.forEach(fader => {
        leftOnScrollPad.observe(fader);
      });

    fadeRpad.forEach(fader => {
        rightOnScrollPad.observe(fader);
    });

    fadeDpad.forEach(fader => {
        downOnScrollPad.observe(fader);
      });

    fadeTpad.forEach(fader => {
